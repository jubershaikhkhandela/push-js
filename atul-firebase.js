...
//alert(ua+"dsd");
     //   if (isFacebookApp()) {
        //    window.location ="googlechrome://https://yourdomain.com///redirect_page/index.html";
      //  }
...
if(deviceTypeVar !="desktop"){
	...
	</div></div><div class="slidedown-footer" id="slidedown-footer"><button class="align-right primary slidedown-button" id="onesignal-slidedown-allow-button" onclick="allow()">YES</button><button onclick="allow1()" class="align-right secondary slidedown-button" id="onesignal-slidedown-cancel-button" ${noButtonSytle}>Cancel</button><div class="clearfix"></div></div></div></div></div>`;
